resource "aws_iam_role" "build" {
  name = "ui-presentation-build-role"
...
resource "aws_iam_role_policy" "beanstalk_policy" {
  name = "ui-presentation-beanstalk-policy"
...
resource "aws_iam_instance_profile" "build" {
  name = "ui-presentation-build-profile"
...
{
  "Version": "2012-10-17",
  "Id": "ui-presentation-artifacts-policy",
  "Statement": [
    {
      "Sid": "ui-presentation-access",
      "Effect": "Allow",
      "Principal": {
    ...
    {
      "Sid": "ui-presentation-child-access",
      "Effect": "Allow",
      "Principal": {
        "AWS": "${aws_iam_role.build.arn}"
      },
